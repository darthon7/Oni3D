...
const menuItems = [
    {
      ...
      items: [
        ...
        { path: "/Calculadora", icon: calculadoraIcon, label: "Calculadora", type: "img" },
        { path: "/calendario", icon: calendar, label: "Calendario", type: "img" },
        { path: "/AgregarAlerta", icon: alertIcon, label: "Agregar Alerta", type: "img" },
      ]
    },
    {
      section: "Clientes",
      items: [
        { path: "/listado", icon: clientesIcon, label: "Clientes", type: "img" },
        { path: "/agregar", icon: addIcon, label: "Agregar Cliente", type: "img" },
      ]
    },
    {
      section: "Productos",
      items: [
        { path: "/Listado_Productos", icon: listIcon, label: "Lista de productos", type: "img" },
        { path: "/Agregar_Producto", icon: addIcon, label: "Agregar producto", type: "img" }
      ]
    },
    {
      section: "Ventas",
      items: [
        { path: "/ProductosVendidos", icon: VentasIcon, label: "Ventas", type: "img" },
      ]
    },
    ...
    
    {
      ...
      items: [
        { path: "/Settings", icon: settingsIcon, label: "Settings", type: "img" },
      ]
    },
];
